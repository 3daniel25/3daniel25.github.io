...
$db         = new conexionDB();
$sql_textos          = $db->query("SELECT * FROM textos");
while ($fetch_textos = $db->recorrer($sql_textos)) {
$textos[]    = $fetch_textos;
}
?>
<!DOCTYPE html>
								...
								<tr>
									<td style="padding:29px 0 30px;">
										<table width="100%" cellpadding="0" cellspacing="0">
											<tr>
												<th class="flex" width="250" align="left" style="padding:0;">
